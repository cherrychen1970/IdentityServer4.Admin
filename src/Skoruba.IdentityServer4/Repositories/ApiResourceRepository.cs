...
namespace Skoruba.EntityFramework.Repositories
{
    ...
    {
        protected readonly IdentityServerConfigurationDbContext DbContext;
        ...
        public virtual async Task<PagedList<ApiResource>> GetApiResourcesAsync(string search, int page = 1, int pageSize = 10)
        {
            ...
            var pagedList = new PagedList<ApiResource>(apiResources);            
        ...
        {            
            ...
            var pagedList = new PagedList<ApiResourceProperty>(properties);            
        ...
        public virtual async Task<PagedList<ApiScope>> GetApiScopesAsync(int apiResourceId, int page = 1, int pageSize = 10)
        {
            ...
            var pagedList = new PagedList<ApiScope>(apiScopes);            
        ...
        {            
            ...
            var pagedList = new PagedList<ApiSecret>(apiSecrets);            
