...
namespace Skoruba.AspNetIdentity.Services
{
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        public virtual async Task<IPagedList<UserDto<TKey>>> GetUsersAsync(string search, int page = 1, int pageSize = 10)
        {
            ...
            //var usersDto = Mapper.Map<IPagedList<UserDto<TKey>>>(pagedList);
        ...
        public virtual async Task<IPagedList<UserDto<TKey>>> GetRoleUsersAsync(string roleId, string search, int page = 1, int pageSize = 10)
        {
        ...
        public virtual async Task<IPagedList<UserDto<TKey>>> GetClaimUsersAsync(string claimType, string claimValue, int page = 1, int pageSize = 10)
        {
        ...
        public virtual async Task<IPagedList<RoleDto<TKey>>> GetRolesAsync(string search, int page = 1, int pageSize = 10)
        {
        ...
        public virtual async Task<IPagedList<UserRoleDto<TKey>>> GetUserRolesAsync(string userId, int page = 1, int pageSize = 10)
        {
            ...
            var roleDtos = Mapper.Map<IPagedList<UserRoleDto<TKey>>>(userIdentityRoles);
        ...
        public virtual async Task<IPagedList<UserClaimDto<TKey>>> GetUserClaimsAsync(string userId, int page = 1, int pageSize = 10)
        {
            var userExists = await IdentityRepository.ExistsUserAsync(userId);
            if (!userExists) throw new UserFriendlyErrorPageException(string.Format(IdentityServiceResources.UserDoesNotExist().Description, userId), IdentityServiceResources.UserDoesNotExist().Description);

            var claims = await IdentityRepository.GetUserClaimsAsync(userId, page, pageSize);
            var claimDtos = Mapper.Map<IPagedList<UserClaimDto<TKey>>>(claims);
            var user = await IdentityRepository.GetUserAsync(userId);
            // CHERRY
            // .UserName=
        ...
        public virtual async Task<IPagedList<UserClaimDto<TKey>>> GetUserClaimAsync(string userId, int claimId)
        {
            var userExists = await IdentityRepository.ExistsUserAsync(userId);
            if (!userExists) throw new UserFriendlyErrorPageException(string.Format(IdentityServiceResources.UserDoesNotExist().Description, userId), IdentityServiceResources.UserDoesNotExist().Description);
            ...
            var userClaimsDto = Mapper.Map<IPagedList<UserClaimDto<TKey>>>(identityUserClaim);
        ...
        public virtual async Task<IdentityResult> CreateUserClaimsAsync(IEnumerable<UserClaimDto<TKey>> claimsDto)
        {
        ...
        public virtual async Task<IdentityResult> UpdateUserClaimsAsync(IEnumerable<UserClaimDto<TKey>> claimsDto)
        {
            var userIdentityUserClaim = Mapper.Map<IdentityUserClaim<TKey>>(claimsDto);
        ...
        public virtual async Task<IdentityResult> CreateRoleClaimsAsync(IEnumerable<RoleClaimDto<TKey>> claimsDto)
        {
        ...
        public virtual async Task<IdentityResult> UpdateRoleClaimsAsync(IEnumerable<RoleClaimDto<TKey>> claimsDto)
        {
            var identityRoleClaim = Mapper.Map<IdentityRoleClaim<TKey>>(claimsDto);
        ...
        public virtual async Task<IPagedList<RoleClaimDto<TKey>>> GetRoleClaimsAsync(string roleId, int page = 1, int pageSize = 10)
        {
            ...
            var roleClaimDtos = Mapper.Map<IPagedList<RoleClaimDto<TKey>>>(identityRoleClaims);
        ...
        public virtual async Task<IPagedList<RoleClaimDto<TKey>>> GetUserRoleClaimsAsync(string userId, string claimSearchText, int page = 1, int pageSize = 10)
        {
            var userExists = await IdentityRepository.ExistsUserAsync(userId);
            if (!userExists) throw new UserFriendlyErrorPageException(string.Format(IdentityServiceResources.UserDoesNotExist().Description, userId), IdentityServiceResources.UserDoesNotExist().Description);
        ...
        public virtual async Task<IPagedList<RoleClaimDto<TKey>>> GetRoleClaimAsync(string roleId, int claimId)
        {
            var roleExists = await IdentityRepository.ExistsRoleAsync(roleId);
            if (!roleExists) throw new UserFriendlyErrorPageException(string.Format(IdentityServiceResources.RoleDoesNotExist().Description, roleId), IdentityServiceResources.RoleDoesNotExist().Description);
            ...
            var roleClaimsDto = Mapper.Map<IPagedList<RoleClaimDto<TKey>>>(identityRoleClaim);
            var roleDto = await GetRoleAsync(roleId);
